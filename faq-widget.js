...
(function () {
  ...
  var FAQ = [
    ...
    },
    {
      ...
      a: 'منصة ShareEdu — Classic ASP + قاعدة بيانات Access.'
    },
    {
      q: 'كم تكلفة الإعداد المقترحة؟',
      a: '15,000 ريال سعودي، لمرة واحدة (2026).'
    },
    {
      q: 'ما قاعدة البيانات الموصى بها؟',
      a: 'PostgreSQL مستقلة، دون أي مساس ببنية ShareEdu الحالية.'
    },
    {
      q: 'ما فروع المدارس؟',
    ...
    {
      q: 'للعام الدراسي كم القبول القادم؟',
      a: '1448-1449هـ الموافق 2026-2027م.'
    },
    {
      q: 'ما اسم المبادرة؟',
      a: 'مبادرة #التحول_الرقمي — مدارس دار الفرسان الأهلية.'
    }
  ];
