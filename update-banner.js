  ...
  var CHANGELOG = [
    {
      ...
      items: [
        ...
        '📌 13 يوليو 2026، 1:53م — استلام أداتين تفاعليتين من المستخدم (Artifacts): متصفّح سيناريوهات وموحّد جدول الخارطة الستة، ولوحة تتبّع حالة الحزمة — التفاصيل الكاملة في ورقة العصف الذهني'
      ],
