...
(function () {
  ...
  var CHANGELOG = [
    {
      version: 'v8.12 (تجريبية)',
      level: 'عام',
      scope: null,
      items: [
        'قفل أمني موحّد على التقرير الشامل والإنفوجرافيك التفاعلي',
        'إصلاح فعلي لخلل ظهور الأسئلة الاستراتيجية في iDar Chatbot',
        'تحديث خارطة طريق الاتحاد (iDar_UN) بخط زمني جديد',
        'تحسينات على مستوى حماية البيانات الشخصية (متوافقة مع PDPL)',
        'الموقع أصبح قابلًا للتثبيت كتطبيق (iOS/Android)'
      ],
      showFrom: '2026-07-19T00:00:00+03:00',
      showUntil: '2026-07-26T00:00:00+03:00'
    },
    {
      ...
      scope: null,
      items: [
        'تبويب "#رؤية_مشتركة" جديد بجانب ETEC — نافذة تعريفية بشريط تقدّم متحرك',
        'iDar Chatbot يدعم الآن أسئلة استراتيجية إضافية لمستخدمين مخوّلين (🔒)',
        'تحسينات على نظام الدخول المقيّد — دعم عدة مستويات وصول'
      ],
      showFrom: '2026-07-14T00:00:00+03:00',
      showUntil: '2026-07-21T00:00:00+03:00'
    },
    {
      version: 'v8.8',
      level: 'عام',
      ...
      items: [
        ...
        'إضافة خطوة "القبول النهائي" لمسار حل معالجة الوقت الراهن + إشادة بالأستاذ محمد بن ناصر آل عامر',
